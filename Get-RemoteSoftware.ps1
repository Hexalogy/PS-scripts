...
cls # Cleans the view when user choose yes
$hname = Read-Host "Hostname"
#Get-InstalledSoftware -ComputerName $hname

# Installed programs only (sorted A-Z): 
#Get-InstalledSoftware -ComputerName $hname -Property installdate,uninstallstring,installlocation | Where-Object {[string]$_.SystemComponent -ne 1 -and ![string]$_.IsMinorUpgrade -and ![string]$_.ReleaseType -and ![string]$_.ParentDisplayName} | Sort-Object ProgramName 

Get-InstalledSoftware -ComputerName $hname -Property installdate | Where-Object {[string]$_.SystemComponent -ne 1 -and ![string]$_.IsMinorUpgrade -and ![string]$_.ReleaseType -and ![string]$_.ParentDisplayName} | Sort-Object ProgramName | Format-Table -Autosize
